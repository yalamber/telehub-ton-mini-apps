    ...
    <>
      ...
      >
        <div className="flex justify-center border-t p-4">
          <AddForm type={type} closeAddModal={closeAddModal} fetchItems={fetchItems} parent={parent} />
        </div>
      </Modal>
      ...
      >
        <div className="flex justify-end border-t p-4">
          ...
          <button onClick={() => handleDelete(deleteID)}  className="bg-blue-500 text-white rounded px-4 py-2">
            Delete
          </button>
        </div>
      </Modal>
      <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <div className="items-center justify-between lg:flex">
          <div className="w-full mb-4 lg:mb-0 flex items-center justify-between">
